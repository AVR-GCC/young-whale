...
export const SubscriptionTerminal = () => {
  ...
  return (
    <div className="w-full max-w-3xl mx-auto mt-16 mb-0 px-4">
      <div className="bg-deep border border-slate-800 rounded-md p-6 font-mono relative overflow-hidden">
        ...
        {!isSubmitted ? (
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 w-full">
              <div className="flex-1 w-full relative group">
                <input
                  ...
                  className={`w-full bg-black/40 border ${error ? 'border-red-500' : 'border-slate-700'} rounded text-white px-4 py-3 outline-none transition-all placeholder:text-slate-500/0 focus:ring-1 focus:ring-[#00E5D2] focus:border-cyan-400 disabled:opacity-50`}
                  spellCheck={false}
                  autoComplete="off"
                  required
                />
          ...
          <div className="text-cyan-400 text-sm sm:text-base tracking-wide mt-2 font-bold my-4">
