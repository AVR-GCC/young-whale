      ...
      <Tooltip.Root>
        ...
        <Tooltip.Portal>
          <Tooltip.Content
            ...
            sideOffset={5}
            className="z-50 w-max max-w-[320px] p-2.5 bg-surface border rounded shadow-xl animate-in fade-in-0 data-[state=closed]:animate-out data-[state=closed]:fade-out-0"
            style={{ borderColor: borderColor || '#334155' }}
          >
            <div className="font-oxanium text-xs text-white whitespace-nowrap text-center leading-relaxed m-0">
              {content}
            </div>
          </Tooltip.Content>
        </Tooltip.Portal>
