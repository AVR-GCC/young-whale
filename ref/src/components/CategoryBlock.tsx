...
export const CategoryBlock: React.FC<CategoryBlockProps> = ({
  ...
  return (
    <div className="flex flex-col bg-deep rounded-xl overflow-hidden border border-[#1E293B]/40 transition-colors break-inside-avoid">
      <div className="px-5 pt-2 pb-1.5 bg-[#0B0F19] flex items-center justify-between border-b border-[#1E293B]/25">
        <div className="flex items-center gap-2">
          ...
          <CustomTooltip content={tooltipText} position="bottom" borderColor={headerColor}>
            <div 
              className="w-4 h-4 rounded-full flex items-center justify-center bg-[#1E293B] font-bold font-serif text-[10px] cursor-default transition-all leading-none italic pb-[1px] border border-transparent box-border"
              style={{ color: '#94A3B8' }}
