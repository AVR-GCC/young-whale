...
export const RadarDetailsModal: React.FC<RadarDetailsModalProps> = ({ 
  ...
  const getRiskBadgeColor = (risk?: string) => {
    switch (risk) {
      ...
      default:
        return 'text-[#94A3B8] bg-[#94A3B8]/10 border-[#1E293B]';
    }
  };
    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
        ...
        <motion.div
          ...
          className="relative w-full max-w-2xl overflow-hidden rounded-2xl border border-[#1E293B] bg-[#131A26] p-6 shadow-2xl md:p-8"
        >
          ...
          <button 
            ...
            className="absolute top-4 right-4 flex h-9 w-9 items-center justify-center rounded-full border border-[#1E293B] bg-[#070A10]/60 text-[#94A3B8] hover:bg-[#1E293B] hover:text-[#F8FAFC] transition-colors"
          >
            <X className="h-4 w-4" />
          </button>
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center gap-4 border-b border-[#1E293B] pb-6 mb-6">
            ...
            <div>
              ...
              <p className="font-outfit text-[#94A3B8] text-sm mt-1">
                Category: <span className="font-semibold uppercase tracking-wider font-oxanium text-[11px] text-opacity-90" style={{ color: getCategoryColor(token.category) }}>
            ...
            <div className="flex items-center gap-3">
              {token.socials?.website && (
                <a 
                  ...
                  className="flex items-center gap-1.5 text-xs font-mono text-[#94A3B8] hover:text-[#00E5D2] transition-colors border border-[#1E293B] px-3 py-2 rounded-lg bg-[#070A10]"
                >
              ...
              className={`flex items-center justify-center gap-2 px-5 py-2.5 rounded-lg text-sm font-mono font-semibold tracking-wider transition-all shadow-lg cursor-pointer
                ${isExpired 
                  ...
                  : isPerfect
                    ...
                    : 'bg-gradient-to-r from-[#00E5D2] to-cyan-600 text-[#070A10] hover:scale-[1.02] active:scale-[0.98]'}`}
            >
