      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-3 md:gap-4">
        ...
        <div className="flex items-center gap-3 w-full md:w-auto justify-between md:justify-start">
          <div className="flex items-center gap-2.5">
            ...
            <div className="relative w-8 h-8 rounded-lg bg-[#131A26] border border-[#1E293B] flex items-center justify-center text-[#00E5D2]">
              <Orbit className="w-5 h-5 animate-spin-slow" />
              <div className="absolute inset-0 bg-cyan-400/20 rounded-lg blur-lg opacity-20" />
            </div>
            
            <div>
              <h1 className="font-oxanium text-lg font-bold text-[#F8FAFC] tracking-normal leading-none uppercase">
                youngwhale<span className="text-[#00E5D2]">.io</span>
              </h1>
              <p className="font-mono text-[9px] text-[#94A3B8] tracking-widest uppercase mt-0.5">
        ...
        <div className="text-center bg-[#0B0F19] px-4 py-2 rounded-lg border border-[#1E293B]/60 max-w-full md:max-w-md lg:max-w-xl flex items-center justify-center gap-2.5">
        ...
        <div className="flex items-center justify-between md:justify-end gap-4 w-full md:w-auto border-t border-[#1E293B]/50 pt-3 md:border-none md:pt-0">
          ...
          <button
            ...
            className={`flex items-center gap-2 px-3 py-1.5 rounded-lg border text-xs font-mono tracking-wider transition-all cursor-pointer
              ${soundEnabled 
                ? 'bg-[#00E5D2]/10 border-[#00E5D2]/30 text-[#00E5D2] font-semibold' 
