  ...
  return (
    <>
      ...
      >
        ...
        {/* Score */}
        <CustomTooltip content={token.isPromoted ? 'Sponsored Ping.' : (isExpired ? 'Expired score. Sonar ping timed out.' : <div className="text-center">Live Sonar Score.<br/>Valid for 24 hours only.</div>)} position="left" borderColor={themeColor}>
        ...
        >
          {token.isPromoted ? 'FEATURED' : (token.time === 'yesterday' ? '1D AGO' : token.time)}
        </div>
      </div>
